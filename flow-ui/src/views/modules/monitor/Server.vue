  ...
  <div v-loading="loading"> 
    <el-row :gutter="12" v-if="ServerOS" >
      <el-col :span="8">
        <el-card shadow="hover" class="server-card">
            <div slot="header" class="clearfix">
              ...
              <el-button @click="refreshList" style="float: right; padding: 3px 0" type="text">{{$i18nMy.t('刷新')}}</el-button>
            </div>
            <el-row>
                  ...
                  <div class="el-table el-table--enable-row-hover el-table--medium">
                    <table cellspacing="0" style="width: 100%;">
                      <tbody>
                        ...
                        <tr>
                          <td><div class="cell">{{$i18nMy.t('核心数')}}</div></td>
              ...
              <el-col :span="24">
               <div class="el-table el-table--enable-row-hover el-table--medium">
                    <table cellspacing="0" style="width: 100%;">
                      <tbody>
                        <tr>
                          <td><div class="cell">{{$i18nMy.t('总内存')}}</div></td>
                          <td><div class="cell">{{ServerOS.mem.total}}G</div></td>
                        </tr>
                        <tr>
                          <td><div class="cell">{{$i18nMy.t('已用内存')}}</div></td>
      ...
      <el-col :span="24">
        <el-card shadow="hover" class="server-card">
            <div slot="header" class="clearfix">
              <span>{{$i18nMy.t('磁盘信息')}}</span>
            </div>
            <div class="el-table el-table--enable-row-hover el-table--medium">
              <table v-if="ServerOS" cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
                  <td><div class="cell">{{$i18nMy.t('磁盘名称')}}</div></td>
                  <td><div class="cell">{{$i18nMy.t('大小')}}</div></td>
                  <td><div class="cell">{{$i18nMy.t('已用')}}</div></td>
                  <td><div class="cell">{{$i18nMy.t('可用')}}</div></td>
                  <td><div class="cell">{{$i18nMy.t('利用率')}}</div></td>
                </tr>
      ...
      <el-col :span="24">
        <el-card shadow="hover" class="server-card">
            <div slot="header" class="clearfix">
              <span>{{$i18nMy.t('服务器信息')}}</span>
            </div>
             <div class="el-table el-table--enable-row-hover el-table--medium">
            <table v-if="ServerOS" cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
                  <td><div class="cell">{{$i18nMy.t('服务器名称')}}</div></td>
                  <td><div class="cell">{{ServerOS.hostname}}</div></td>
                </tr>
                <tr>
                  <td><div class="cell">{{$i18nMy.t('操作系统')}}</div></td>
                ...
                <tr>
                  <td><div class="cell">{{$i18nMy.t('系统架构')}}</div></td>
