 ...
 * Copyright (c) 2020
 *
 * Released under the jeeplus.org license
 * http://jeeplus.org
 *
 * Date: 2021-01-15
 */
(function (global, factory) {
	...
	var _objectRefs_0_3_0_objectRefs = refs;

	var Collection = collection;
	_objectRefs_0_3_0_objectRefs.Collection = Collection;

	var parentRefs = new _objectRefs_0_3_0_objectRefs({ name: 'children', enumerable: true, collection: true }, { name: 'parent' }),
	    labelRefs = new _objectRefs_0_3_0_objectRefs({ name: 'labels', enumerable: true, collection: true }, { name: 'labelTarget' }),
	    attacherRefs = new _objectRefs_0_3_0_objectRefs({ name: 'attachers', collection: true }, { name: 'host' }),
	    outgoingRefs = new _objectRefs_0_3_0_objectRefs({ name: 'outgoing', collection: true }, { name: 'source' }),
	    incomingRefs = new _objectRefs_0_3_0_objectRefs({ name: 'incoming', collection: true }, { name: 'target' });
	...
	var diRefs = new _objectRefs_0_3_0_objectRefs(
