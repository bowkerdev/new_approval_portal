...
var getBusinessObject = require('jeeplus-bpmn/lib/util/ModelUtil').getBusinessObject;

var is = require('jeeplus-bpmn/lib/util/ModelUtil').is,
    isAny = require('jeeplus-bpmn/lib/features/modeling/util/ModelingUtil').isAny;
