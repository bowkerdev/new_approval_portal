<template>
	<view>
		<cu-custom bgColor="bg-gradual-pink" :isBack="true"><block slot="backText">{{$i18nMy.t('返回')}}</block><block slot="content">{{$i18nMy.t('卡片')}}</block></cu-custom>
			...
			<view class="cu-item shadow">
				<view class="image">
					<image src="https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg"
					 mode="widthFix"></image>
					<view class="cu-tag bg-blue">{{$i18nMy.t('史诗')}}</view>
					<view class="cu-bar bg-shadeBottom"> <text class="text-cut">{{$i18nMy.t('我已天理为凭，踏入这片荒芜，不再受凡人的枷锁遏制。我已天理为凭，踏入这片荒芜，不再受凡人的枷锁遏制。')}}</text></view>
				</view>
			...
			<view class="cu-item shadow">
				...
				<view class="cu-list menu-avatar comment solids-top">
					<view class="cu-item">
						...
						<view class="content">
							<view class="text-grey">{{$i18nMy.t('莫甘娜')}}</view>
			...
			<view class="cu-item shadow">
				...
				<view class="content">
					...
					<view class="desc">
						...
						<view>
							<view class="cu-tag bg-red light sm round">{{$i18nMy.t('正义天使')}}</view>
							<view class="cu-tag bg-green light sm round">{{$i18nMy.t('史诗')}}</view>
						</view>
					</view>
				</view>
			</view>
