...
public class GetDbData {
	public static JSONArray getData(String sql) {
        ...
        //URL指向要访问的数据库名mydata
        String url = "jdbc:mysql://gmfzhimi.oicp.io:29823/security?verifyServerCertificate=false&characterEncoding=UTF-8&useSSL=false&allowMultiQueries=true&autoReconnect=true&serverTimezone=UTC";
        //MySQL配置时的用户名
        String user = "root";
        //MySQL配置时的密码
