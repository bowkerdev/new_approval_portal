...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(KickoutSessionControlFilter kickoutSessionControlFilter,
        ...
        filterRuleMap.put( "/sys/dict/getAll", "anon");
        filterRuleMap.put( "/sys/dict/getCache", "anon");
        filterRuleMap.put( "/sys/sysSimpleLanguage/getAll", "anon");
        filterRuleMap.put( "/servlet/validateCodeServlet", "anon");
        filterRuleMap.put( "/sys/login", "anon");
        filterRuleMap.put( "/sys/tokenLogin", "anon");
        filterRuleMap.put( "/sys/casLogin", "anon");
		filterRuleMap.put( "/app/sys/login", "anon");
        filterRuleMap.put( "/sys/area/treeData", "anon");
        filterRuleMap.put( "/sys/logout", "anon");
