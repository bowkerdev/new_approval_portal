	...
	<view>
		<view class="fixed">
			<cu-custom :isBack="true" bgColor="bg-shadeTop text-white">
				...
				<block slot="content">{{$i18nMy.t('垂直导航')}}</block>
			</cu-custom>
		</view>
				...
				<view class="padding-top padding-lr" v-for="(item,index) in list" :key="index" :id="'main-'+index">
					...
					<view class="cu-list menu-avatar">
						...
						<view class="cu-item ">
							...
							<view class="content">
								<view class="text-pink"><text class="text-cut">{{$i18nMy.t('莫甘娜')}}</text></view>
								<view class="text-gray text-sm flex"> <text class="text-cut">{{$i18nMy.t('凯尔，你被自己的光芒变的盲目！')}}</text></view>
							</view>
							<view class="action">
								<view class="text-grey text-xs">22:20</view>
						...
						<view class="cu-item grayscale">
							...
							<view class="content">
								<view><text class="text-cut">{{$i18nMy.t('伊泽瑞尔')}}</text>
