<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>{{$i18nMy.t('每周')}}</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="5" size="mini" border>{{$i18nMy.t('不指定')}}</el-radio>
    </div>
    <div>
      ...
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18nMy.t('至星期')}}</span>
    ...
    <div>
      ...
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18nMy.t('周，星期')}}</span>
      <el-input-number @change="type = '7'" v-model="week.end" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
    </div>
    <div>
      <el-radio v-model="type" label="6" size="mini" border>{{$i18nMy.t('本月最后一个')}}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{$i18nMy.t('星期')}}</span>
