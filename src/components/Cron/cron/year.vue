<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>{{$i18n.t('每年')}}</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2000"  size="mini" style="width: 100px;"></el-input-number>{{$i18n.t('年')}}</div>
  </div>
</template>
