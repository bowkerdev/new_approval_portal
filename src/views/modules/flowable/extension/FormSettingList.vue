<template>
  <div>
      ...
      <el-row>
        <el-button v-if="hasPermission('extension:formSetting:add')" type="primary" size="small" icon="el-icon-plus" @click="add()">{{$i18nMy.t('新建')}}</el-button>
        ...
        <el-button v-if="hasPermission('extension:formSetting:import')" type="default" size="small" icon="el-icon-upload2" @click="isImportCollapse = !isImportCollapse, isSearchCollapse=false">{{$i18nMy.t('导入')}}</el-button>
        <el-button v-if="hasPermission('extension:formSetting:export')" type="default" size="small" icon="el-icon-download" @click="exportExcel()">{{$i18nMy.t('导出')}}</el-button>
        <el-button
          type="default"
          size="small"
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template  slot-scope="scope">
          ...
          <el-button v-if="hasPermission('extension:formSetting:del')" type="text" size="mini" icon="el-icon-delete"  @click="del(scope.row.id)">{{$i18nMy.t('删除')}}</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
