...
<div>
  <el-dialog
		...
		<el-col :span="24">
		 <el-form-item label-width="0">
            ...
            <el-tab-pane :label="{{$i18nMy.t('按钮设置')">
                  <el-button size="small" @click="addFlowButtonRow" type="primary">{{$i18nMy.t('新增')}}</el-button>
                  <el-table
                  border
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      <el-button @click="viewFlowButtonRow(scope.row)" type="text" size="small">{{$i18nMy.t('查看')}}</el-button>
                      <el-button  @click="editFlowButtonRow(scope.row)" type="text" size="small">{{$i18nMy.t('编辑')}}</el-button>
                      <el-button  @click="delFlowButtonRow(scope.row)" type="text" size="small">{{$i18nMy.t('删除')}}</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              </el-tab-pane>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" v-if="method != 'view'" @click="doSubmit()">{{$i18nMy.t('确定')}}</el-button>
    </span>
  </el-dialog>
