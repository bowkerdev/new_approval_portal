    ...
    <el-form :model="inputForm" v-loading="loading" status-icon ref="inputForm" @keyup.enter.native="inputFormSubmit()"
       ...
       <el-row :gutter="15">
        <el-col :span="12">
           ...
           <el-form-item :label="$i18n.t('流程分类')" prop="category" :rules="[
            {required: true, message: '流程分类不能为空', trigger: 'blur'}
          ]">
          <el-select v-model="inputForm.category" :placeholder="$i18n.t('请选择')"  style="width: 100%;">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item :label="$i18n.t('模型标识')" prop="key" :rules="[{required: true, message: '模型标识不能为空', trigger: 'blur'}]">
            <el-input v-model="inputForm.key" maxlength="50" placeholder=""></el-input>
          </el-form-item>
        </el-col>
    
        <el-col :span="12">
          <el-form-item :label="$i18n.t('模型名称')" prop="name" :rules="[
        ...
        <el-col :span="12">
          <el-form-item :label="$i18n.t('模块描述')" prop="description">
            <el-input type="textarea" v-model="inputForm.description" :placeholder="$i18n.t('备注')"></el-input>
          </el-form-item>
        </el-col>
