    ...
    <el-row :gutter="10" style="margin-bottom: 10px">
      <el-col :lg="9" :md="24" :sm="24" :xs="24">
        ...
        >
          <el-row>
            <el-col :span="8">
              <el-progress type="circle" :percentage="28">{{$i18nMy.t('中式快餐')}}</el-progress>
            </el-col>
            <el-col :span="8">
               <el-progress type="circle" :percentage="22">{{$i18nMy.t('西餐')}}</el-progress>
            </el-col>
            <el-col :span="8">
              <el-progress type="circle" :percentage="32">{{$i18nMy.t('火锅')}}</el-progress>
            </el-col>
          </el-row>
        </el-card>
      </el-col>
