<template>
  <el-dialog
    ...
    <el-form :model="inputForm" v-loading="loading" :class="method==='view'?'readonly':''" :disabled="method==='view'" ref="inputForm" @keyup.enter.native="doSubmit()"
          ...
          <el-form-item :label="$i18n.t('规则实体类')" prop="className">
              <el-input  v-model="inputForm.className" :placeholder="$i18n.t('规则实体类')"></el-input>
          ...
          <el-form-item :label="$i18n.t('规则字段')" prop="field">
              <el-input  v-model="inputForm.field" :placeholder="$i18n.t('规则字段')"></el-input>
          </el-form-item>
