<template>
  <el-dialog
    ...
    <el-row :gutter="15">
        <el-col :span="12">
          <el-form-item prop="photo" :label="$i18n.t('头像')"> 
            <el-upload
        ...
        <el-col :span="12">
           <el-form-item prop="office.id" :label="$i18n.t('部门')">
            <SelectTree 
              ref="officeTree"
              :props="{
                  value: 'id',             // ID字段名
        ...
        <el-col :span="12">
            <el-form-item :label="$i18n.t('工号')" prop="no" :rules="[{required: true, message:'工号不能为空', trigger:'blur'}]">
              <el-input v-model="inputForm.no" maxlength="50" placeholder=""></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$i18n.t('岗位')" prop="post.id">
               <el-select v-model="inputForm.post.id" style="width:100%" :placeholder="$i18n.t('请选择')">
                <el-option
        ...
        <el-col :span="12">
          <el-form-item :label="$i18n.t('角色')" prop="roleIdList">
              <el-checkbox-group 
        ...
        <el-col :span="12">
           <el-form-item label="密码:" prop="newPassword" :rules="inputForm.id?[]:[{required: true, message:'密码不能为空', trigger:'blur'}]">
              <el-input v-model="inputForm.newPassword" maxlength="50" :placeholder="$i18n.t('若不修改，请留空')" show-password></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$i18n.t('确认密码')" prop="confirmNewPassword" :rules="inputForm.id?[]:[{required: true, message:'确认密码不能为空', trigger:'blur'}]">
        ...
        <el-col :span="12">
           <el-form-item :label="$i18n.t('邮箱')" prop="email" :rules="[{type:'email', message:'请输入正确的邮箱地址', trigger:'blur'}]">
            <el-input v-model="inputForm.email" maxlength="50" placeholder=""></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$i18n.t('是否允许登录')" prop="loginFlag">
