<template>
  <div>
      ...
      <el-row>
        <el-button v-if="hasPermission('test:grid:testCountry:add')" type="primary" size="small" icon="el-icon-plus" @click="add()">{{$i18n.t('新建')}}</el-button>
    ...
    <el-table-column
      ...
      <el-table-column
        ...
        :label="$i18n.t('操作')">
        <template  slot-scope="scope">
          <el-button v-if="hasPermission('test:grid:testCountry:view')" type="text" icon="el-icon-view" size="small" @click="view(scope.row.id)">{{$i18n.t('查看')}}</el-button>
          <el-button v-if="hasPermission('test:grid:testCountry:edit')" type="text" icon="el-icon-edit" size="small" @click="edit(scope.row.id)">{{$i18n.t('修改')}}</el-button>
          <el-button v-if="hasPermission('test:grid:testCountry:del')" type="text"  icon="el-icon-delete" size="small" @click="del(scope.row.id)">{{$i18n.t('删除')}}</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
