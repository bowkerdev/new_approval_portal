...
<div>
  <el-dialog
    ...
    <el-form :model="inputForm" ref="inputForm" v-loading="loading" :class="method==='view'?'readonly':''"  :disabled="method==='view'"
      ...
      <el-row  :gutter="15">
        <el-col :span="12">
            <el-form-item :label="$i18n.t('类型名')" prop="name"
                :rules="[
                  {required: true, message:'类型名不能为空', trigger:'blur'}
                 ]">
              <el-input v-model="inputForm.name" :placeholder="$i18n.t('请填写类型名')"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
            <el-form-item :label="$i18n.t('父级编号')" prop="parent.id"
                :rules="[
